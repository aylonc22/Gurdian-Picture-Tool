...
namespace Gurdian_Picture_Tool
{
    public partial class Form1 : SfForm
    {
        ...
        public Form1()
        {
            ...
            this.label1.Text = Properties.Settings.Default.savePath;
        }
                ...
                foreach (var img in imgs)
                {
                    if (!img.Contains("full"))
                    {
                        ...
                        if (this.checkBox1.Checked)
                            Form2.Apply(bm, bmFull, bmName, img, full, toSave==null? Properties.Settings.Default.savePath : toSave);
                        else
                        {
                            Form2 form2 = new Form2(bm, bmFull, bmName, img, full, toSave == null ? Properties.Settings.Default.savePath : toSave);
                            form2.ShowDialog();
                        }
                    }
                }
