    ...
    public partial class Form2 : SfForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                JsWrap(bmFullPath, saveFile + "\\Full_Light", false);
        ...
        private void pictureBox1_MouseMove(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (getRatio(crpY, true) == e.Y || getRatio(crpY, true) == e.Y + 1 || getRatio(crpY, true) == e.Y - 1 || getRatio(crpY + height1, true) == e.Y || getRatio(crpY + height1, true) == e.Y + 1 || getRatio(crpY + height1, true) == e.Y - 1)
                    this.Cursor = Cursors.SizeNS;
                else
                    if (getRatio(crpX) == e.X || getRatio(crpX) == e.X + 1 || getRatio(crpX) == e.X - 1 || getRatio(crpX + width1) == e.X || getRatio(crpX + width1) == e.X + 1 || getRatio(crpX + width1) == e.X - 1)
        ...
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            if (getRatio(crpY, true) < e.Y && getRatio(crpY + height1, true) > e.Y && getRatio(crpX) < e.X && getRatio(crpX + width1) > e.X)
                shouldMove = true;
            if (getRatio(crpY, true) == e.Y || getRatio(crpY, true) == e.Y + 1 || getRatio(crpY, true) == e.Y - 1)
                shouldTop = true;
            else
           if (getRatio(crpY + height1, true) == e.Y || getRatio(crpY + height1, true) == e.Y + 1 || getRatio(crpY + height1, true) == e.Y - 1)
                shouldBot = true;
            else
           if (getRatio(crpX) == e.X || getRatio(crpX) == e.X + 1 || getRatio(crpX) == e.X - 1)
                shouldLeft = true;
            else
           if (getRatio(crpX + width1) == e.X || getRatio(crpX + width1) == e.X + 1 || getRatio(crpX + width1) == e.X - 1)
                shouldRight = true;
        }
        ...
        private void pictureBox2_MouseMove(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (getRatio(crpY2, true) == e.Y || getRatio(crpY2, true) == e.Y + 1 || getRatio(crpY2, true) == e.Y - 1 || getRatio(crpY2 + height2, true) == e.Y || getRatio(crpY2 + height2, true) == e.Y + 1 || getRatio(crpY2 + height2, true) == e.Y - 1)
                    this.Cursor = Cursors.SizeNS;
                else
                    if (getRatio(crpX2) == e.X || getRatio(crpX2) == e.X + 1 || getRatio(crpX2) == e.X - 1 || getRatio(crpX2 + width2) == e.X || getRatio(crpX2 + width2) == e.X + 1 || getRatio(crpX2 + width2) == e.X - 1)
                    this.Cursor = Cursors.SizeWE;
                else
        ...
        private void pictureBox2_MouseDown(object sender, MouseEventArgs e)
        {
            if (getRatio(crpY2, true) < e.Y && getRatio(crpY2 + height2, true) > e.Y && getRatio(crpX2) < e.X && getRatio(crpX2 + width2) > e.X)
                shouldMove2 = true;
            if (getRatio(crpY2, true) == e.Y || getRatio(crpY2, true) == e.Y + 1 || getRatio(crpY2, true) == e.Y - 1)
                shouldTop2 = true;
            else
            if (getRatio(crpY2 + height2, true) == e.Y || getRatio(crpY2 + height2, true) == e.Y + 1 || getRatio(crpY2 + height2, true) == e.Y - 1)
                shouldBot2 = true;
            else
            if (getRatio(crpX2) == e.X || getRatio(crpX2) == e.X + 1 || getRatio(crpX2) == e.X - 1)
                shouldLeft2 = true;
            else
            if (getRatio(crpX2 + width2) == e.X || getRatio(crpX2 + width2) == e.X + 1 || getRatio(crpX2 + width2) == e.X - 1)
                shouldRight2 = true;
        }
        ...
        /// </summary>
        /// <param name="flag"></param>
        private static void JsWrap(string input, string output, bool _temp = true)
        {
            bool flag = Properties.Settings.Default.format.Equals("png") ? true : false;
            System.Diagnostics.Process process = new System.Diagnostics.Process();
            System.Diagnostics.ProcessStartInfo startInfo = new System.Diagnostics.ProcessStartInfo();
            startInfo.WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden;
            startInfo.FileName = "cmd.exe";            
            startInfo.WorkingDirectory = "C:\\Users\\boogy\\desktop" + "\\js";
            if (flag)
            {
                double fs = new FileInfo(input).Length / 1024;
                int pngQuality = (int)(((double)Properties.Settings.Default.pngQualityInKB / fs) * 100.0);
                if (pngQuality > 100)
                    pngQuality = 100;
                if (pngQuality < 6)
                    pngQuality = 6;
                startInfo.Arguments = "/C node index " + input + " png " + output + " " + bmName + " " + pngQuality.ToString();
            }
            else
                startInfo.Arguments = "/C  node index "+ input + " jpg " + output + " " + bmName + " " + Properties.Settings.Default.jpgQuality + " " + Properties.Settings.Default.r + " " + Properties.Settings.Default.g + " " + Properties.Settings.Default.b;
            ...
            if (_temp)
            {
                var t = new Thread(() =>
                {
                    ...
                    {
                        Thread.Sleep(200);
                        if ((flag && File.Exists(output + bmName + ".png")) || (!flag && File.Exists(output + bmName + ".jpg")))
                        {
                            try
                            {
                                File.Delete(input);
